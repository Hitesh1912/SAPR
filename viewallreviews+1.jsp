...
String t1="abundant";
	...
	ResultSet rs2=st2.executeQuery("select * from pos1 where category='"+x1+"' and f1='"+x2+"' and t1='"+x3+"' ");
	
	if(rs2.next()==true)
	{
		Statement st1=connection.createStatement();
	    st1.executeUpdate("update pos1 set total='"+count+"', pos='"+count1+"' where category='"+x1+"' ");
	}
	else
	{
		Statement st1=connection.createStatement();
	    st1.executeUpdate("insert into pos1 values('"+x1+"','"+x2+"','"+x3+"','"+count+"','"+count1+"')");
	}
